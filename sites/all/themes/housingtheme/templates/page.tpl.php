      ...
      <div class="dashboard">
            ...
            <ul class="nav nav-pills flex-column mb-auto">
               ...
               <li class="nav-item has-submenu">
                  ...
                  <ul class="submenu collapse">
                     <li><a class="nav-link" href="allotment.html">Allotment</a></li>
         ...
         <div id="content-wrapper" class="content-wrapper">
            <div class="main-content w-100 p-5">
               ...
               <div class="row">
                  <h4 class="mt-4">New Application List</h4>
                  <div class="col-md-9">
                        ...
                        <table class="table table-list">
                           ...
                           <tbody>
                              <tr>
                                 ...
                                 <td><a href="#" class="btn bg-primary btn-sm px-5 rounded-pill text-white fw-bolder">View</a></td>
                                 <td>
                           ...
                           <div id="carouselExampleCaptions" class="carousel slide h-100" data-bs-ride="carousel">
                              ...
                              <div class="carousel-inner text-center ">
                                 <div class="carousel-item active p-3">
                                    <img src="./images/notification.png" class="w-75"/>
                                    <h5>Latest Notification</h5>
                                    <p>View Upcoming Retirement List</p>
                                    <button type="button" class="btn btn-secondary btn-sm">Download List</button>
                                 </div>
                                 <div class="carousel-item p-3">
                                    <img src="./images/notification.png" class="w-75"/>
                                    <h5>Latest Notification</h5>
                                    <p>View Unauthorized Occupants List</p>
                                    <button type="button" class="btn btn-secondary btn-sm">Download List</button>
                                 </div>
                              </div>
                           </div>
